...
const cartItems = [
  ...
  function removeItem(index) {
    ...
    const removeBtn1 = document.querySelector(`.${index}-delete`);
    const buycontent1 = document.querySelector(`.buy-content${index}`);
    const confirmdelete1 = document.querySelector(`.confirm-delete${index}`);
    const confirmdelete1right = document.querySelector(`.confirm-delete${index}-right`);
    const btnyes1 = document.querySelector(`.btn-yes${index}`);
    const btnno1 = document.querySelector(`.btn-no${index}`);
    const itembuy1 = document.getElementById(`itembuy-delete${index}`);
