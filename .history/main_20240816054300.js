...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const footerServiceOption = document.querySelector('.footer_service_option');

  imgAdd.addEventListener('click', function() {
      const isExpanded = footerServiceOption.classList.toggle('show');

      // Đổi src của img_add ngay lập tức khi click
      imgAdd.src = isExpanded ? './assets/tru.png' : './assets/cong.png';
  });
});
