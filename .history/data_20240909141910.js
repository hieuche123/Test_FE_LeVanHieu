...
const cartItems = [
        ...
        itemElement.innerHTML = `
            ...
            <div class="buy-content buy-content${item.index}">
              ...
              <div class="item-buy-action">
                <svg class="delete1 ${item.index}-delete" onclick="deleteItem(${item.index})" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  function removeItem(index) {
    ...
    function deleteItem(index) {
        ...
        const removeBtn1 = document.querySelector(`.item${index}-delete`); // Nút xóa của sản phẩm
