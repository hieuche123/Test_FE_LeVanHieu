  ...
  function renderCart() {
    ...
    cartItems.map(item => {
        ...
        itemElement.innerHTML = `
            <div class="item-buy item-buy${item.index}" id="itembuy-delete${item.index}">
            ...
            <div class="confirm-delete${item.index}">
              <div class="confirm-delete${item.index}-left">
                ...
                <div class="btn-delete-order">
                  <button class="btn-yes${item.index}" aria-label="btn-yes1">YES</button>
...
const buycontent1 = document.querySelector('.item-buy1');
