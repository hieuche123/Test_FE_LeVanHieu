...
const cartItems = [
  ...
  function renderCart() {
    ...
    cartItems.map(item => {
        ...
        itemElement.className = 'item-buy d-flex';
        ...
        itemElement.innerHTML = `
            ...
            <div class="buy-content buy-content${item.index}">
              <div class="item-buy-content d-flex-c">
                <div class="item-buy-title">
                  <p class="buy-title-name f-weight-4 f-size-16">${item.name}</p>
                  <p class="buy-title-color">Black / M</p>
                </div>
                <div class="item-buy-price f-weight-5" id="${item.id}-price">$${(item.price).toFixed(2)}</div>
                <div class="item-buy-total item-controls d-flex-center">
                  <button  onclick="changeQuantity('${item.id}', -1, 'cartContext${item.id}')" class="reduce_quantity" aria-label="reduce_quantity"><svg width="10" height="2" viewBox="0 0 10 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button onclick="changeQuantity('${item.id}', 1 , 'otherContext')" class="increase_quantity" aria-label="increase_quantity"><svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="item-buy-action d-flex-c">
  ...
  function removeItem(itemId) {
    ...
    if (itemIndex !== -1) {
        ...
        if (element3) {
          // Lấy giá trị hiện tại và chuyển đổi từ chuỗi sang số nguyên
          var currentValue3 = parseInt(element3.textContent, 10);
