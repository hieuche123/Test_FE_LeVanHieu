...
// Dữ liệu giỏ hàng
const cartItems = [
    { id: 'item1', name: 'Square Textured Striped', price: 100, quantity: 1 },
    { id: 'item2', name: 'Square Textured Stripe2', price: 200, quantity: 1 }
  ];
        ...
        itemElement.innerHTML = `
            ...
            <div class="buy-content buy-content1">
              ...
              <div class="item-buy-action">
                <svg class="delete1" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="confirm-delete1">
              <div class="confirm-delete1-left">
                <p>Add to wishlist before remove?</p>
                <div class="btn-delete-order">
                  <button class="btn-yes1" aria-label="btn-yes1">YES</button>
                  <button class="btn-no1" aria-label="btn-yes2">NO</button>
                </div>
              </div>
              <div class="confirm-delete1-right">
          ...
          <span class="item-total" id="${item.id}-total">${item.price * item.quantity} VND</span>
