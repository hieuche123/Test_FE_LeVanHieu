            ...
            <div class="buy-content buy-content${item.index}">
              <div class="item-buy-content d-flex-c">
                ...
                <div class="item-buy-total item-controls d-flex-center">
                  <button  onclick="changeQuantity('${item.id}', -1, 'cartContext')" class="reduce_quantity" aria-label="reduce_quantity"><svg width="10" height="2" viewBox="0 0 10 2" fill="none" xmlns="http://www.w3.org/2000/svg">
