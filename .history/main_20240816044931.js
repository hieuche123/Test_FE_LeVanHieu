...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const defaultItemRect = defaultActiveItem.getBoundingClientRect();
  const parentRect = defaultActiveItem.parentElement.getBoundingClientRect();
  const defaultScrollPosition = defaultItemRect.left - parentRect.left + (defaultItemRect.width / 2) - (footerScroll.clientWidth / 2);
