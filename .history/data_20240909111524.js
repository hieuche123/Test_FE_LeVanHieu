        ...
        itemElement.innerHTML = `
            ...
            <div class="buy-content buy-content1">
              ...
              <div class="item-buy-action">
                <svg class="delete1" id="${item.id}-delete" onclick="changeQuantity('${item.id}')" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const removeBtn1 = document.getElementById(`${item.id}-delete`);
