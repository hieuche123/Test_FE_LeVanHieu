...
document.addEventListener('DOMContentLoaded', function() {
  function toggleServiceOption(imgSelector, optionSelector) {
      ...
      const img_add_categories = document.querySelector('.img_add_categories');
      const img_add_service = document.querySelector('.img_add_service');
      ...
      serviceOption.style.maxHeight = '0px'; // Hiển thị phần tử ngay từ đầu

   

      img_add_categories.addEventListener('click', function() {
        ...
        if (serviceOption.style.maxHeight === '0px' || serviceOption.style.maxHeight === '') {
            ...
            document.querySelector('.footer_categories_option').style.marginBottom = '10px';
            
        } else {
            serviceOption.style.maxHeight = '0px';
            imgAdd.src = './assets/cong.png'; // Đổi src khi đóng
            document.querySelector('.footer_categories_option').style.marginBottom = '0px';
        }
    });


    img_add_service.addEventListener('click', function() {
      // Toggle max-height for slide down/up effect
      if (serviceOption.style.maxHeight === '0px' || serviceOption.style.maxHeight === '') {
          serviceOption.style.maxHeight = defaultHeight;
          imgAdd.src = './assets/tru.png'; // Đổi src khi mở
          document.querySelector('.footer_service_option').style.marginBottom = '10px';
          
      } else {
          serviceOption.style.maxHeight = '0px';
          imgAdd.src = './assets/cong.png'; // Đổi src khi đóng
          document.querySelector('.footer_service_option').style.marginBottom = '0px';
      }
  });
