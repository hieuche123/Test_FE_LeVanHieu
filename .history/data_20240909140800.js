...
const cartItems = [
  ...
  function removeItem(index) {
    ...
    function deleteItem(index) {
        ...
        const removeBtn1 = document.querySelector(`.item-delete`); // Nút xóa của sản phẩm
        const buycontent1 = document.querySelector(`.buy-content`); // Nội dung sản phẩm
        const confirmdelete1 = document.querySelector(`.confirm-delete`); // Xác nhận xóa
        const confirmdelete1right = document.querySelector(`.confirm-delete-right`); // Phần tử trong phần xác nhận
        const btnyes1 = document.querySelector(`.btn-yes`); // Nút xác nhận "Có"
        const btnno1 = document.querySelector(`.btn-no`); // Nút xác nhận "Không"
        const itembuy1 = document.getElementById(`itembuy-delete`); // Phần tử giỏ hàng sản phẩm
